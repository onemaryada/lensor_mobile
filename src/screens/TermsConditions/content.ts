...
export const TERMS_SECTIONS: DocumentSection[] = [
  ...
  },
  {
    ...
    body: 'To the maximum extent permitted by law, the developer is not liable for any indirect or consequential damages arising from the use of, or inability to use, the app.',
  },
  {
    title: 'Changes to These Terms',
    body: 'Terms may be revised in future versions of the app. Continued use after an update constitutes acceptance of the revised terms.',
  },
];
